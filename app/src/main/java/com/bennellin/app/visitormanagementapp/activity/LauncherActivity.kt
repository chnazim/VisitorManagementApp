...
import com.bennellin.app.visitormanagementapp.tab.activity.HomeActivityTab
            ...
            lifecycleScope.launch {
                ...
                if (isLoggedIn) {
                    ...
                    val intent = Intent(
                        ...
                        com.bennellin.app.visitormanagementapp.tab.activity.LoginActivity::class.java
                    )
                    startActivity(intent)
                }
                finish()
